    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto">
                <h2>作業時間編集</h2>
                <form action="{{ action('Admin\TimeController@update') }}" method="post" enctype="multipart/form-data">
                    @if (count($errors) > 0)
                        <ul>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="time" class="form-control" name="time" value="{{ $task_form->time, \Carbon\Carbon::now()->format('G:i:s') }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2">終了時間</label>
                        <div class="col-md-10">
                            <input type="time" class="form-control" name="end" value="{{ $task_form->end, \Carbon\Carbon::now()->format('G:i:s') }}">
                        </div>
                    </div>
